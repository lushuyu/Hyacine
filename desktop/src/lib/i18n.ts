...
const messages = {
  en: {
    ...
    providerSubtitle:
      'Claude, OpenAI, DeepSeek, local Ollama — or anything OpenAI-compatible.',
    ...
    providerCustomSubtitle: 'Point at any OpenAI-compatible or Anthropic-compatible endpoint.',
    ...
    providerCategoryCnOfficial: 'China-region official',
    providerCategoryAggregator: 'Aggregator',
    providerCategoryLocal: 'Local / self-hosted',
    providerCategoryCustom: 'Custom',
    providerFmtAnthropicCli: 'Claude CLI',
    providerFmtAnthropicHttp: 'Anthropic HTTP',
    providerFmtOpenaiChat: 'OpenAI-compatible',
    providerKeyClearedToast: 'Stored key cleared.',
    providerReachableToast: 'Provider reachable',
    providerAnthropicHelp: 'Anthropic-compatible: host + base path, we append /v1/messages.',
    providerOpenaiHelp: 'OpenAI-compatible: include the /v1 segment, we append /chat/completions.',
  ...
  'zh-CN': {
    ...
    providerCustomSubtitle: '指向任意 OpenAI 兼容或 Anthropic 兼容端点。',
    providerBaseUrl: 'Base URL',
    ...
    providerCategoryCnOfficial: '国内官方',
    providerCategoryAggregator: '聚合平台',
    providerCategoryLocal: '本地 / 自建',
    providerCategoryCustom: '自定义',
    providerFmtAnthropicCli: 'Claude CLI',
    providerFmtAnthropicHttp: 'Anthropic HTTP',
    providerFmtOpenaiChat: 'OpenAI 兼容',
    providerKeyClearedToast: '已清除保存的密钥。',
    providerReachableToast: '连接正常',
    providerAnthropicHelp: 'Anthropic 兼容端点：填写 host + base path，我们会追加 /v1/messages。',
    providerOpenaiHelp: 'OpenAI 兼容端点：包含 /v1 段，我们会追加 /chat/completions。',
