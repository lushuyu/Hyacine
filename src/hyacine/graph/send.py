...
def render_html_body(
    ...
    *,
    ...
    footer with model/date metadata). Optional kwargs populate the
    footer's "Generated by" line and the header's date display; defaults
    keep the shell self-contained for tests and ad-hoc previews.
    """
